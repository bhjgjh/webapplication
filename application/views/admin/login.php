...
<head>
  ...
  <title> Espoir Soft Pvt.Ltd</title>
...
<div class="sidebar-brand-ico"style="height:50px; ">
...
<div class="login-box">
  ...
  <div class="card">
    ...
    <img src="http://localhost/webapplication/public/espoirsoft.jpg" id="img">
  </div>
    <?php
    // error message dene ka dusra tarika
